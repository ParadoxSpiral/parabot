...
parabot uses an sqlite database for persistence, to integrate into an existing db run ```$ sqlite3 my_db.db < migrations/20170627120831_pending_tells/up.sql```, or ```[...]down.sql``` to remove tables.
